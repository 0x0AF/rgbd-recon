...
namespace kinect
{
CalibrationInverter::CalibrationInverter(std::vector<std::string> const &calib_volume_files, gloost::BoundingBox const &bbox) : m_cv_xyz_filenames(), m_frustums{}, m_bbox{bbox}
{
