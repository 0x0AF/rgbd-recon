...
extern "C" double copy_reference()
{
    ...
    checkCudaErrors(cudaMemset(_dev_res.out_tsdf_ref, 0, _host_res.measures.data_volume_res.x * _host_res.measures.data_volume_res.y * _host_res.measures.data_volume_res.z * sizeof(uchar)));
